  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <h3 className="text-2xl text-white">Admin</h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/match-settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('match-settings') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/match-makings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('match-makings') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/daily-bonus-config"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('daily-bonus-config') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              {/* <li>
                <NavLink
                  to="/quest"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('quest') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
