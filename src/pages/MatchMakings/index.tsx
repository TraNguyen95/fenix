  ...
  return (
    <div>
      <div className='mb-4 flex items-center justify-between'>
        <span className='text-title-md2 font-semibold text-black'>Match Making</span>
        <ButtonWithIcon name='Add New' className='mb-5 mt-5' path={`add`} />
      </div>

      <TableMatchMaking
        list={matchMakings.data.matchKing}
        total={matchMakings.data.numberOfMatchMaking}
        ...
        <table className='w-full table-auto'>
          <thead>
            <tr className='bg-gray-2 dark:bg-meta-4 text-left'>
              ...
              <th className='min-w-[150px] py-4 px-4 font-medium font-semibold text-black dark:text-white'>
                Medal Weight
              </th>
              <th className='min-w-[120px] py-4 px-4 font-medium font-semibold text-black dark:text-white'>
                Win Loss Weight
              </th>
              <th className='min-w-[120px] py-4 px-4 font-medium font-semibold text-black dark:text-white'>
                Point Range
