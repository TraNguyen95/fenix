...
export default function DetailMatchSetting() {
  ...
  console.log(matchSetting?.rounds)

  const params = useParams()
  const navigate = useNavigate()
  const getMatchSetting = async () => {
    setLoading(true)
    const data: any = await matchSettingApi.getMatchSetting(params.id as string)
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className='flex flex-col gap-9'>
        <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
          <div className='border-b border-stroke py-4 px-6.5 dark:border-strokedark'>
            <h3 className='text-title-md2 font-semibold text-black dark:text-white'>Edit</h3>
          </div>
          <div className='p-6.5'>
      ...
      <input className='lex mt-2 w-full justify-center rounded bg-primary p-3 font-medium text-gray' type='submit' />
    </form>
  )
}
          ...
          >
            <div className='px-2 py-2'>
              ...
              <Input
                ...
                register={register}
                errorMessage={Array.isArray(errors?.rounds) && errors.rounds[index]?.roundNo?.message}
            ...
            <div className='px-2 py-2'>
              ...
              <Input
                ...
                register={register}
                errorMessage={Array.isArray(errors?.rounds) && errors.rounds[index]?.roundName?.message}
                rules={getRules().RequiredCoinsItem}
                className={inputCustom}
                placeholder='Name'
              />
            ...
            <div className='px-2 py-2'>
              <SelectOption
                ...
                register={register}
                rules={getRules().RequiredCoinsItem}
                errorMessage={Array.isArray(errors?.rounds) && errors.rounds[index]?.roundType?.message}
              />
            </div>
            <div className='px-2 py-2'>
              <label className='mb-2.5 block font-semibold text-black dark:text-white'>
              ...
              <Input
                ...
                register={register}
                errorMessage={Array.isArray(errors?.rounds) && errors.rounds[index]?.mainDuration?.message}
            ...
            <div className='px-2 py-2'>
              ...
              <Input
                ...
                register={register}
                errorMessage={
                  Array.isArray(errors?.rounds) && errors.rounds[index]?.preparationTimeBeforeMatch?.message
                }
                className={inputCustom}
            ...
            <div className='px-2 py-2'>
              ...
              <Input
                ...
                register={register}
                errorMessage={Array.isArray(errors?.rounds) && errors.rounds[index]?.timeRemaining?.message}
                className={inputCustom}
            ...
            <div className='px-2 py-2'>
              ...
              <Input
                ...
                register={register}
                errorMessage={Array.isArray(errors?.rounds) && errors.rounds[index]?.totalGoldRewards?.message}
                className={inputCustom}
            ...
            <div className='px-2 py-2'>
              ...
              <Input
                ...
                errorMessage={
                  Array.isArray(errors?.rounds) &&
                  Array.isArray(errors?.rounds[nestIndex]?.medalRates) &&
                  errors?.rounds[nestIndex]?.medalRates[k]?.receivedMedals?.message
                }
                rules={getRules().position}
                className={inputCustom}
