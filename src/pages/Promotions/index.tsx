        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              <th className="min-w-[150px] py-4 px-4 text-black dark:text-white font-semibold">
                Package Order
              </th>
              <th className="min-w-[120px] py-4 px-4 text-black dark:text-white font-semibold">
                Quantity
              </th>
              <th className="min-w-[120px] py-4 px-4 text-black dark:text-white font-semibold">
                HasRibbon
